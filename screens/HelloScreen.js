...
const SENTENCES = [
    "Hello --> Namaskaram (Sanskrit)",
    "Hello --> Ninhao (Chineese)",
    "Hello --> Bonjour (French)",
    "Hello --> Konnichiwa (Japanese)",
    "Hello --> Salve (Italian)",
    "Hello --> Olá (Portuguese)",
    "Hello --> Salam (Persian)",
    "Hello --> Asalaam Alaikum (Arabic)",
    "Hello --> Anyoung haseyo (Korean)",
    "Hello --> Hola (Spanish)",
    "Hello --> Guten Tag (German)",
    "Hello --> God dag (Danish)",
    "Hello --> Merhaba (Turkish)",
    "Hello --> Shikamoo (Swahili)",
...
copyToClipboard = async (sentences) => {
 ...
 <Text style={styles.header}>Say Hi/Hello in different Languages👋 :</Text>
